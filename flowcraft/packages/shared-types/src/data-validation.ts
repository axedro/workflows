...
export function validateWorkflowDataFlow(
  ...
  for (const edge of edges) {
    if (edge.data && edge.data.dataFlow) {
      ...
      const dummySourcePort: DataPort = {
        id: 'dummy-source',
        name: 'Source',
        type: 'output',
        fields: [],
      ...
      const dummyTargetPort: DataPort = {
        id: 'dummy-target',
        name: 'Target',
        type: 'input',
        fields: [],
 ...
 */
export function isTypeCompatible(targetType: DataType, sourceType: DataType): boolean {
 ...
 */
export function canConvertType(fromType: DataType, toType: DataType): boolean {
 ...
 */
export function validatePortCompatibility(sourcePort: DataPort, targetPort: DataPort): boolean {
 ...
 */
export function isConditionOperatorValid(operator: string, fieldType: DataType): boolean {
 ...
 */
export function isConditionValueCompatible(value: any, fieldType: DataType): boolean {
  const valueType = getValueType(value);
