...
export async function i18nRoutes(fastify: FastifyInstance) {
  ...
  fastify.get('/translations/:language', {
    ...
    try {
      ...
      const translations = await i18nService.getTranslations(language, namespace);
  ...
  fastify.get('/translations/:language/:namespace', {
    schema: {
  ...
  fastify.get('/translation/:language/:key', {
    schema: {
  ...
  fastify.get('/detect-language', {
    ...
    try {
      ...
      const detectedLanguage = i18nService.detectLanguageFromHeader(acceptLanguage);
  ...
  fastify.put('/translations/:language', {
